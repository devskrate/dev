...
*Jekflix Template* allows you to personalize your site with several settings. See the [docs](https://github.com/thiagorossener/jekflix-template/wiki/settings) for more details.
